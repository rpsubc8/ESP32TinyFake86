...
//unsigned char keydown[0x100]
unsigned char keyboardwaitack = 0;
//extern uint32_t usegrabmode;

//extern void doirq (unsigned char irqnum);
//JJ extern uint8_t running, 
//JJ unsigned char portram[0x10000];
...
uint8_t buttons = 0;
//JJ #ifdef use_lib_mouse
//JJ  extern void sermouseevent (uint8_t buttons, int8_t xrel, int8_t yrel);
//JJ #endif
//JJ extern struct sermouse_s sermouse; //no uso raton
...
//JJ			setwindowtitle (" (press Ctrl + Alt to release mouse)");
		}
			...
			switch (event.type) {
					case SDL_KEYDOWN:
                        ...
                        if (event.key.keysym.sym == SDLK_F8)
                        {
                         ...
                         {//Partir del snapshot inicial
                          gb_force_snapshot_begin = 1;
                         }                                   
                         if (event.key.keysym.sym == SDLK_F10)
                         {//Hacer snapshot snapshot
                          gb_force_snapshot_end = 1;
                         }                          
                        #endif 
					...
					case SDL_MOUSEMOTION:
						...
						#ifdef use_lib_mouse
						 //JJ sermouseevent (buttons, (int8_t) mx, (int8_t) my);
						#endif 
